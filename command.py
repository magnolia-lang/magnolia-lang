...
if __name__ == '__main__':
    rew_configs = [ ##("DNFIntroducePsi", 100)
                  ...
                  #, ("OFSpecializePsiGenerator", "1|g")
                  , ("OFSpecializeSnippetGenerator", "1|g")
                  , ("OFSpecializePsi", 10)
                  , ("OFReduceMakeIx", 10)
                  , ("OFReduceMakeIxRotate", 20)
                  , ("OFPad", 1)
                  , ("ExtOFSpecializePsi", "1|g")
                  , ("OFSpecializePsiForallPadded", 1)
                  , ("OFEliminateModuloPadding", 10)
                  #, ("OFSpecializePsiGenerator", "1|g")
                  ##, ("OFPad", 1)
                  ##, ("OFTile", 1)
                  #, ("OFLiftCores", 1)
