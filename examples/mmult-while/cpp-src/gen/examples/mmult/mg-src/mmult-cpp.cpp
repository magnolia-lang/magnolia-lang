#include "gen/examples/mmult/mg-src/mmult-cpp.hpp"
...
namespace mmult_cpp {
    ...
    ArrayProgram::_test_matrix ArrayProgram::test_matrix;
    ...
    ArrayProgram::_zeros ArrayProgram::zeros;

    matrix<ArrayProgram::Int32> ArrayProgram::__matrix;
    ...
    ArrayProgram::_print_number ArrayProgram::print_number;
