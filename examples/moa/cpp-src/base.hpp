...
struct matrix {
    ...
    inline matrix::Matrix iota(const Size size) {
...
template <typename _Context1, typename _Context2, typename _Context3, typename _Context4, typename _State1, class _body, class _cond>
struct while_loop4_1 {
	...
	_body body;
	_cond cond;
	void repeat(const Context1 &context1, const Context2 &context2, const Context3 &context3, const Context4 &context4, State1 &state1) {
		while (cond(context1, context2, context3, context4, state1)) body(context1, context2, context3, context4, state1);
	}
};

template <typename _Context1, typename _Context2, typename _Context3, typename _State1, class _body, class _cond>
struct while_loop3_1 {
	typedef _Context1 Context1;
	typedef _Context2 Context2;
	typedef _Context3 Context3;
	typedef _State1 State1;
	...
	_body body;
	_cond cond;
	void repeat(const Context1 &context1, const Context2 &context2, const Context3 &context3, State1 &state1) {
		while (cond(context1, context2, context3, state1)) body(context1, context2, context3, state1);
	}
};
