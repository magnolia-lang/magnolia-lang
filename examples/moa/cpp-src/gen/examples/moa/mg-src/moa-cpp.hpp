...
public:
    ...
    struct _get_shape {
        inline ArrayProgram::Shape operator()(const ArrayProgram::Matrix& m) {
            return __matrix.get_shape(m);
        };
    };

    static ArrayProgram::_get_shape get_shape;
    ...
    struct _iota {
        inline ArrayProgram::Matrix operator()(const ArrayProgram::Size& i) {
            return __matrix.iota(i);
        };
    };

    static ArrayProgram::_iota iota;
    struct _size {
...
public:
    ...
    struct _isLowerThanInner {
        inline bool operator()(const ArrayProgram::Matrix& m1, const ArrayProgram::Matrix& m2, const ArrayProgram::Int32& a, const ArrayProgram::Int32& b, const ArrayProgram::Int32& c, const ArrayProgram::Int32& d, const ArrayProgram::Matrix& mres) {
            return ArrayProgram::isLowerThan(d, a);
        };
    };
...
public:
    ...
    struct _isLowerThanMid {
        inline bool operator()(const ArrayProgram::Matrix& m1, const ArrayProgram::Matrix& m2, const ArrayProgram::Int32& a, const ArrayProgram::Int32& b, const ArrayProgram::Int32& c, const ArrayProgram::Int32& d, const ArrayProgram::Int32& e, const ArrayProgram::Matrix& mres) {
            return ArrayProgram::isLowerThan(e, a);
        };
    };

    static ArrayProgram::_isLowerThanMid isLowerThanMid;
    struct _isLowerThanOuter {
        inline bool operator()(const ArrayProgram::Matrix& m1, const ArrayProgram::Matrix& m2, const ArrayProgram::Int32& a, const ArrayProgram::Int32& b, const ArrayProgram::Int32& c, const ArrayProgram::Int32& d, const ArrayProgram::Int32& e, const ArrayProgram::Int32& f, const ArrayProgram::Matrix& mres) {
            return ArrayProgram::isLowerThan(f, a);
        };
    };
...
public:
    ...
    struct _access_shape {
        inline ArrayProgram::Size operator()(const ArrayProgram::Matrix& m, const ArrayProgram::Index& i) {
            return __matrix.access_shape(m, i);
        };
    };
