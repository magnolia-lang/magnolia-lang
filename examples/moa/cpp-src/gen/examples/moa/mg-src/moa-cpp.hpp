...
private:
    static inline void one0(TestingSuite::Int32& o) {
        o = __int32_utils.one();
    };
    static inline void zero0(TestingSuite::Int32& o) {
        o = __int32_utils.zero();
    };
public:
    ...
    struct _binary_add {
        ...
        inline TestingSuite::Float64 operator()(const TestingSuite::Float64& a, const TestingSuite::Float64& b) {
            return __float64_utils.binary_add(a, b);
        };
    };
    ...
    struct _eq {
        inline bool operator()(const TestingSuite::Float64& a, const TestingSuite::Float64& b) {
            return __float64_utils.eq(a, b);
        };
    ...
    struct _unary_sub {
        ...
        inline TestingSuite::Float64 operator()(const TestingSuite::Float64& a) {
            return __float64_utils.unary_sub(a);
        };
    };
...
private:
    static inline void one0(TestingSuite::Float64& o) {
        o = __float64_utils.one();
    };
    static inline void zero0(TestingSuite::Float64& o) {
        o = __float64_utils.zero();
    };
public:
    ...
    struct _ravel {
        inline TestingSuite::Array operator()(const TestingSuite::Array& a) {
            ...
            TestingSuite::UInt32 c = TestingSuite::elem_uint(TestingSuite::zero.operator()<Int32>());
            TestingSuite::Array flat = TestingSuite::create_array(TestingSuite::create_shape1(TestingSuite::total(a)));
            TestingSuite::rav_repeat(a, ix_space, flat, c);
            return flat;
        };
    };
    ...
    struct _ravel_body {
        inline void operator()(const TestingSuite::Array& input, const TestingSuite::IndexContainer& ix_space, TestingSuite::Array& flat, TestingSuite::UInt32& c) {
            TestingSuite::Index multi_ix = TestingSuite::get_index_ixc(ix_space, c);
            TestingSuite::Index linear_ix = TestingSuite::create_index1(c);
            TestingSuite::set(flat, linear_ix, TestingSuite::unwrap_scalar(TestingSuite::get(input, multi_ix)));
            c = TestingSuite::elem_uint(TestingSuite::binary_add(TestingSuite::uint_elem(c), TestingSuite::one.operator()<Int32>()));
        };
    };

    static TestingSuite::_ravel_body ravel_body;
    struct _ravel_cond {
        inline bool operator()(const TestingSuite::Array& input, const TestingSuite::IndexContainer& ix_space, const TestingSuite::Array& flat, const TestingSuite::UInt32& c) {
            return TestingSuite::lt(TestingSuite::uint_elem(c), TestingSuite::uint_elem(TestingSuite::total(input)));
        };
    };

private:
    static while_loop2_2<TestingSuite::Array, TestingSuite::IndexContainer, TestingSuite::Array, TestingSuite::UInt32, TestingSuite::_ravel_body, TestingSuite::_ravel_cond> __while_loop2_2;
public:
