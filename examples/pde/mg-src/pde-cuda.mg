package examples.pde.mg-src.pde-cuda imports examples.pde.mg-src.pde-pad;
...
implementation ExtScalarIndex = external CUDA [dims=(a,b,c), globals=()]
    base.scalar_index {
  require type Index;
...
implementation ExtAxisLength = external CUDA [dims=(a,b,c), globals=()]
    base.axis_length {
...
implementation ExtArrayOps = external CUDA [dims=(a,b,c), globals=()] base.array_ops {
  require type Float;
  type Array;
  type Offset;
  type Axis;
...
implementation ExtConstants = external CUDA [dims=(a,b,c), globals=()] base.constants {
  type Float;
  function nu(): Float;
  function dt(): Float;
  function dx(): Float;
