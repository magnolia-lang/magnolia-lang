package examples.fizzbuzz.mg-src.fizzbuzz-cuda;

// The longest fizzbuzz in the world!
implementation ImplFizzBuzz = external CUDA [dims=(a,b,c),globals=()]
    base.fizzbuzz_ops {
...
implementation ImplTypes = external CUDA [dims=(a,b,c),globals=()]
    base.basic_types {
    type Int32;
}
