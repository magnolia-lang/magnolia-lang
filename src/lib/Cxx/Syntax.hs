...
-- | Pretty-prints a C++ package as a string based on a base path and an
-- output mode.
...
-- | Pretty-format a C++ package as a string corresponding to a header file
-- based on a base path and an output mode.
